...
export default function TheatreOwnerSignup() {
  ...
  const validateForm = () => {
    ...
    if (!agreedToTerms) {
      newErrors.terms = 'You must agree to the partnership terms';
    }
    return newErrors;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        await signup(formData.fullName, formData.email, formData.password, 'theatreOwner');
          ...
          <div className="p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                Partner with CineBook
              </h1>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Register as a theatre owner to start selling tickets
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Owner Name Input */}
              <div>
                <label htmlFor="fullName" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Owner Name</label>
                <input
                  type="text"
                  id="fullName"
                  name="fullName"
              ...
              <button
                ...
                className="w-full py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-95 mt-6 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100"
              >
                {isSubmitting ? (
                  <>
            ...
            <div className="text-center mt-6">
              <p className="text-gray-600 dark:text-gray-400">
                Already registered?{' '}
                <Link to="/theatre-login" className="font-semibold text-primary hover:text-primary-dark transition-colors">
                  Sign In
                </Link>
              </p>
            </div>
